        ...
        <div className="body min-vh-100">
            ...
            <div className="card m-4 p-3" style={{ "width": "50rem", "height": "fit-content" }}>
                ...
                <div className="card-body">
                    ...
                    <p className="mb-3">First Name: {userProfileInfo?.loginInfo?.firstname}</p>
                    <p className="mb-3">Last Name: {userProfileInfo?.loginInfo?.lastname}</p>
                    ...
                    <div className="bg-secondary p-3 rounded-2" style={{"--bs-bg-opacity": .1}}>
                        <div className="mb-3">
                            ...
                            <input type="email" className="form-control" id="email" defaultValue={userProfileInfo?.loginInfo?.email} readOnly={toggle}/>
                        </div>
                        <div className="mb-3">
                            <label htmlFor="mobile" className="mb-1">Mobile No:</label>
                            <input type="text" className="form-control" id="mobile" defaultValue={userProfileInfo?.mobile} readOnly={toggle}/>
                        </div>
                        <div className="mb-3">
                            <button type="submit" className="btn btn-primary" onClick={handleToggle}>{submit? "Submit" : "Confirm"}</button>
                        </div>
                    </div>
